...
plot_categories <- function(category_1 = "All", category_2 = "All",
  ...
  g2 <- data_tbl %>%
    ...
    scale_y_continuous(labels = euro_format(suffix = "K €")) +
    labs(
...
# 5- Quarterly Total Sales
plot_categories(category_1 = "Road", unit = period(months = 3), date_format = "%B %d, %Y", interactive = TRUE)

# 6- Monthly Total Sales
plot_categories(category_1 = "Road",unit = "monthly", date_format = "%B %Y", interactive = TRUE)

# 7-Weekly Total Sales
plot_categories(category_1 = "Road",unit = "weekly", date_format = "%B %d, %Y", interactive = TRUE)


# Mountain

# 5- Quarterly Total Sales
plot_categories(category_1 = "Mountain", unit = period(months = 3), date_format = "%B %d, %Y", interactive = TRUE)

# 6- Monthly Total Sales
plot_categories(category_1 = "Mountain",unit = "monthly", date_format = "%B %Y", interactive = TRUE)

# 7-Weekly Total Sales
plot_categories(category_1 = "Mountain",unit = "weekly", date_format = "%B %d, %Y", interactive = TRUE)
