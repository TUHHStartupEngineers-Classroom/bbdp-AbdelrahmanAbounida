...
```{r, fig.cap="Revenue by Category", out.height="600px", echo=FALSE,results='hide'}
# 1- Data Preparation 
...
```{r, out.height='1200px',out.width='700px', echo=FALSE}
...
```{r, fig.cap="Revenue by Category", echo=FALSE}
plot_categories <- function(category_1 = "All", category_2 = "All",
  ...
  g2 <- data_tbl %>%
    ...
    scale_y_continuous(labels = euro_format(scale = 1e-2, suffix = "K €")) +
    labs(
...
## Quarterly
```{r, out.height='1500px',out.width='700px', echo=FALSE}
#  Quarterly Total Sales
...
## Weekly
```{r, out.height='1900px',out.width='700px', echo=FALSE}
# Weekly Total Sales
...
## Quarterly
```{r, out.height='1700px',out.width='700px', echo=FALSE}
#  Quarterly Total Sales
plot_categories(category_1 = "Mountain", unit = period(months = 3), date_format = "%B %d, %Y", interactive = TRUE)
```

## Monthly
```{r,out.height='1800px',out.width='700px', echo=FALSE}
# Monthly Total Sales
...
```{r,out.height='2400px',out.width='800px', echo=FALSE}
# Weekly Total Sales
